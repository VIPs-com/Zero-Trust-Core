...
**Como usar:** projete cada bloco `--- SLIDE N ---` em tela cheia; ou *Print* → PDF (uma seção por página). Compatível com [Marp](https://marp.app/) se quiser tema visual depois.
...
- Trilha OpenPGP (Expert): [OpenPGP-GPG do Zero ao Expert](https://github.com/VIPs-com/OpenPGP-GPG-do-Zero-ao-Expert)

---

*Slides de abertura · VIPs-com · alinhado ao inventário v1.0.2*
