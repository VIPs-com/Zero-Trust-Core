...
| [**SLIDES-ABERTURA-TURMA.marp.md**](./SLIDES-ABERTURA-TURMA.marp.md) | Mesmos 4 slides no formato **Marp** (slide show / export PDF) |
...
| [**VALIDACAO-EM-CAMPO-EQUIPE.md**](./VALIDACAO-EM-CAMPO-EQUIPE.md) | **Equipe:** protocolo de testes em campo dos artefatos novos (Whonix, borg, restore-test) — checklists + o que capturar/enviar para validação |
...
| [**APOSTILA-GUIA-PRATICO.md**](./APOSTILA-GUIA-PRATICO.md) | **Aluno avançado:** guia prático em 9 capítulos — hardware alternativo, DIY, governança, automação; Capítulo 10 = referência rápida por cenário |
